...
public final class FoldableFuns {
     ...
     *
     * @param foldable implementation of {@link com.dan323.functional.annotation.funcs.IFoldable}
     * @param fClass class of the type constructor that was made a foldable by {@param foldable}
     * @param felement element of type {@param fClass} appplied to some type {@code A}
     * @return true iff {@param felement} has no elements to be folded
     * @param <FA>
     * @param <F>
     */
    ...
    public static <G,FA extends F,F,A> boolean contains(IFoldable<F> foldable, Class<F> fClass, A elem, FA felement){
