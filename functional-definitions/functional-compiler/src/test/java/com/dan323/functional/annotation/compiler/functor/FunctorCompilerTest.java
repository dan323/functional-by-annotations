...
public class FunctorCompilerTest {
    ...
    public void eitherFunctor(){
        List<String> args = Stream.of("../annotation-definitions/src/main/java/com/dan323/functional/annotation/Functor",
                        "src/test/java/com/dan323/functional/annotation/compiler/functor/EitherF")
    ...
    public void functorNoPublicFun() {
        List<String> args = Stream.of("../annotation-definitions/src/main/java/com/dan323/functional/annotation/Functor",
                        "src/test/java/com/dan323/functional/annotation/compiler/functor/NoPublicMapFunctor")
                .map(s -> Paths.get(s + ".java").toAbsolutePath().toString())
                .collect(Collectors.toList());
        args.addAll(0, List.of("-processor", FunctionalCompiler.class.getName()));
        String[] flags = args.toArray(new String[4]);
    ...
    public void functorMonad(){
        List<String> args = Stream.of("../annotation-definitions/src/main/java/com/dan323/functional/annotation/Functor",
                        "src/test/java/com/dan323/functional/annotation/compiler/functor/FunctorMonad")
                .map(s -> Paths.get(s + ".java").toAbsolutePath().toString())
                .collect(Collectors.toList());
        args.addAll(0, List.of("-processor", FunctionalCompiler.class.getName()));
        String[] flags = args.toArray(new String[4]);
    ...
    public void functorNoPublicClass(){
        var args = Stream.of("../annotation-definitions/src/main/java/com/dan323/functional/annotation/Functor",
                        "src/test/java/com/dan323/functional/annotation/compiler/functor/NoPublicTypeFunctor")
                .map(s -> Paths.get(s + ".java").toAbsolutePath().toString())
                .collect(Collectors.toList());
        args.addAll(0, List.of("-processor", FunctionalCompiler.class.getName()));
    ...
    public void functorNoStaticRun() {
        List<String> args = Stream.of("../annotation-definitions/src/main/java/com/dan323/functional/annotation/Functor",
                        "src/test/java/com/dan323/functional/annotation/compiler/functor/NoStaticFunctor")
                .map(s -> Paths.get(s + ".java").toAbsolutePath().toString())
                .collect(Collectors.toList());
        args.addAll(0, List.of("-processor", FunctionalCompiler.class.getName()));
        String[] flags = args.toArray(new String[4]);
    ...
    public void functorRun() {
        List<String> args = Stream.of("../annotation-definitions/src/main/java/com/dan323/functional/annotation/Functor",
                        "src/test/java/com/dan323/functional/annotation/compiler/functor/FunctorMock")
                .map(s -> Paths.get(s + ".java").toAbsolutePath().toString())
                .collect(Collectors.toList());
        args.addAll(0, List.of("-processor", FunctionalCompiler.class.getName()));
        String[] flags = args.toArray(new String[4]);
