...
public class MonadUtilTest {
    ...
    public void monadFapplyError(){
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> ApplicativeUtil.<MonadNoPure, List, List<Integer>, List<Integer>, List<Function<Integer, Integer>>>fapply(MonadNoPure.MONAD, List.class, List.of(1, 2), List.of((Integer x) -> x + 1, (Integer x) -> x * 2)));
        assertTrue(ex.getMessage().contains("The monad is not correctly implemented"));
        IllegalArgumentException ex2 = assertThrows(IllegalArgumentException.class, () -> ApplicativeUtil.<EmptyMonad, List, List<Integer>, List<Integer>, List<Function<Integer, Integer>>>fapply(EmptyMonad.MONAD, List.class, List.of(1, 2), List.of(x -> x + 1, x -> x * 2)));
        assertTrue(ex2.getMessage().contains("The monad is not correctly implemented"));
    }

    @Test
    public void monandFapply() {
        var sol = ApplicativeUtil.<MonadMock, List, List<Integer>, List<Integer>, List<Function<Integer, Integer>>>fapply(MonadMock.MONAD, List.class, List.of(2, 3, 4), List.of(x -> x + 1, x -> x - 3));
    ...
    public void monadLiftA2(){
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> ApplicativeUtil.<EmptyMonad,List,List<Integer>,List<Integer>,List<Integer>,Integer,Integer,Integer>liftA2(EmptyMonad.MONAD, List.class, Integer::sum, v, w));
        assertTrue(exception.getMessage().contains("The monad is not correctly implemented"));
    }

    @Test
    public void monadNoPure() {
        assertThrows(IllegalArgumentException.class, () -> ApplicativeUtil.<MonadNoPure, List, List<Integer>, Integer>pure(MonadNoPure.MONAD, List.class, 5));
    }
    ...
    public void monandMap() {
        var sol = FunctorUtil.<MonadMock, List, List<Integer>, List<Integer>, Integer, Integer>map(MonadMock.MONAD, List.class, List.of(2, 3, 4), x -> x + 2);
